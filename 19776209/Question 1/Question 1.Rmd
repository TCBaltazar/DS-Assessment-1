...
dp <- df_mov%>%arrange(Profitability)

d <- dp %>% ggplot(aes(x=Lead.Studio, y=Profitability)) + geom_bar(stat="identity") + theme_bw() + theme(legend.position = "right") + labs(x = "Lead Studio", 
